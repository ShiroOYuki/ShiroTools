"""
Django settings for ShiroTools project.
...
SECRET_KEY = 'django-insecure-t86q35k1=y_s(y%bxm#2&oaapss$kgu-)daukeq&wj^9uyns%q'
...
WSGI_APPLICATION = 'ShiroTools.wsgi.application'
